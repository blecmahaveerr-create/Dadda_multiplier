...
REM
REM Generated by Vivado on Mon Apr 27 23:20:32 +0530 2026
...
echo "xvlog --incr --relax -prj dadda_mul_tb_vlog.prj"
call xvlog  --incr --relax -prj dadda_mul_tb_vlog.prj -log xvlog.log
